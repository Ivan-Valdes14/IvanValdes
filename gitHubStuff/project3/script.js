...
/*This is a sample text file used as input for Project 3. It contains regular English text in sentences and paragraphs that are analyzed by the program. The program counts the total number of words. It also counts the number of long words in the file. A word is considered long if it has more than five characters. The program also counts the number of sentences by counting the number of periods in the file. The also program counts the most and least frequent words. This concludes this sample input file. Have a nice day.*/
/*The University of North Florida is a nationally ranked university in the heart of Jacksonville committed to student success. Located on a beautiful campus just minutes from the beach, UNF offers students small class sizes and individualized attention, countless opportunities to gain real-world experience while in school, strong job placement, an active student life, Division I athletics, and a welcoming and engaged community. It’s all here, and it’s all Uniquely UNF. Become an Osprey. 12345 34543 345345 34535 3535*/
